...
export const FORM_TEMPLATE = (params: { title: string }) => ({
  ...
  questions: [
    ...
    },
    {
      ...
      options: [
        { title: "Hispanic"},
        { title: "White alone, non-Hispanic"},
        { title: "Black or African American alone, non-Hispanic"},
        { title: "American Indian and Alaska Native alone, non-Hispanic"},
        { title: "Asian alone, non-Hispanic"},
        { title: "Native Hawaiian and Other Pacific Islander alone, non-Hispanic"},
        { title: "Some Other Race alone, non-Hispanic"},
        { title: "Multiracial, non-Hispanic"},
