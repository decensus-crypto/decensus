      ...
      <Box as="section" w="full" h={{ base: 320, md: 600 }}>
        <Container maxWidth="6xl">
          <Grid templateColumns="repeat(12, 1fr)" gap={4}>
            ...
            <GridItem colSpan={{ base: 12, md: 6 }} display={{ base: "none", md: "block" }}>
          ...
          <Grid templateColumns="repeat(12, 1fr)" gap={4} py={24}>
            ...
            <GridItem colSpan={{ base: 12, md: 6 }}>
              <Text fontSize="lg">
                ...
                their members such as opinions, personal information or preferences. Decensus was
                created by Centiv to address the lack of solutions in this space, and was developed
                during the Metabolisms&amp; ETH Global hackathon in 2022, where it finished
                finalist.
              </Text>
            </GridItem>
          </Grid>
